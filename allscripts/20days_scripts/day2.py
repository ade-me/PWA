...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create a QWebEngineView to embed Streamlit
        self.webview = QWebEngineView()
        layout.addWidget(self.webview)

        # Load the Streamlit app into the webview
        self.load_streamlit()

    def load_streamlit(self):
        # Create a Streamlit application in a temporary file
        with open("streamlit_app.py", "w") as f:
            f.write(streamlit_app.__code__)

        # Load the Streamlit app into the QWebEngineView
        self.webview.load("file:///streamlit_app.py")
